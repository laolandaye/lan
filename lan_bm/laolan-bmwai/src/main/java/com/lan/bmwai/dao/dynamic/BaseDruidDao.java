 ...
 * <E> E queryForObject
 */
public interface BaseDruidDao {

    //为ps对象设置参数
    public void setParameters(PreparedStatement ps, Object[] params) throws SQLException;

    // insert、update、delete封装到一个方法中
    int executeUpdate(String dbConfPath, String sql, Object... params) throws SQLException;

    // 批量插入
    int[] executeBatch(String dbConfPath, String sql, List<Object[]> params) throws SQLException;
     ...
     */
    List<Map<String, Object>> queryForList(String dbConfPath, String sql, Object... params);

    /**
     * 通过 PDruidRowMapper 接口定义的规范，将每一行转换为对应的对象
     */
    <E> List<E> queryForList(String dbConfPath, PDruidRowMapper<E> mapper, String sql, Object... params);
