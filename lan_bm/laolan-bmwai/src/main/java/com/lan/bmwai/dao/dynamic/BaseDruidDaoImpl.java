 ...
 * <E> E queryForObject
 */
public class BaseDruidDaoImpl implements BaseDruidDao {
    ...
    @Override
    public int executeUpdate(String dbConfPath, String sql, Object... params) throws SQLException {
        Connection conn = DruidUtil.getConnection(dbConfPath);
        PreparedStatement ps = conn.prepareStatement(sql);
        setParameters(ps, params);
        int n = ps.executeUpdate();
        DruidUtil.release(null, ps, null);
        return n;
    }
    ...
    // 批量插入
    @Override
    public int[] executeBatch(String dbConfPath, String sql, List<Object[]> params) throws SQLException  {
        Connection conn = DruidUtil.getConnection(dbConfPath);
        PreparedStatement ps = conn.prepareStatement(sql);
     ...
     */
    @Override
    public List<Map<String, Object>> queryForList(String dbConfPath, String sql, Object... params) {
        List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
            conn = DruidUtil.getConnection(dbConfPath);
            ps = conn.prepareStatement(sql);
            setParameters(ps, params);
    ...
    /**
     * 通过PDruidRowMapper接口定义的规范，将每一行转换为对应的对象
     *
     * @param mapper
     * @param sql
     * @param params
     ...
     */
    @Override
    public <E> List<E> queryForList(String dbConfPath, PDruidRowMapper<E> mapper, String sql, Object... params) {
     ...
     */
    @Override
    public <E> List<E> queryForList(String dbConfPath, Class<E> clazz, String sql, Object... params) {
        List<E> result = new ArrayList<>();
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
     ...
     */
    @Override
    public Map<String, Object> queryForObject(String dbConfPath, String sql, Object... params) {
    ...
    @Override
    public <E> E queryForObject(String dbConfPath, PDruidRowMapper<E> mapper, String sql, Object... params) {
        E result = null;
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    @Override
    public <E> E queryForObject(String dbConfPath, Class<E> clazz, String sql, Object... params) {
        E obj = null;
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
