...
public class DtfpQueryData extends CommonJunitTest {
    ...
    static {
        teamXzqy = new HashMap() {{
            put("SysTeam_T003", "XZ_11"); put("SysTeam_XZ_10","XZ_10");
        }};
        xzqyTeam = new HashMap() {{
            put("XZ_11", "SysTeam_T003"); put("XZ_10", "SysTeam_XZ_10");
        }};
    }
