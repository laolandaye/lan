...
public class HtjdQueryData extends CommonJunitTest {
     ...
     * zs_area_info
     */
    public static List<Map<String, Object>> queryZsAreaInfo() {
        String sql = "  SELECT * FROM zs_area_info  ";
        List<Map<String, Object>> list = baseDao.queryForList(sql);
     ...
     * zs_company_info
     */
    public static List<Map<String, Object>> queryZsCompanyInfo() {
        String sql = "  SELECT * FROM zs_company_info  ";
        List<Map<String, Object>> list = baseDao.queryForList(sql);
