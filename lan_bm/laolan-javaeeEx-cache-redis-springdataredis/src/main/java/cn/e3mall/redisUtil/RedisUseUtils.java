...
public class RedisUseUtils {
    ...
    public static void del(String ... key){
        if(key!=null&&key.length>0){
            if(key.length==1){
                redisUtils.redisTemplate.delete(key[0]);
            }else{
                redisUtils.redisTemplate.delete(CollectionUtils.arrayToList(key));
            }
        }
    }
    ...
    public static Object hget(String key,String item){
        ...
        Object res = null;
        try {
            res = redisUtils.redisTemplate.opsForHash().get(key, item);
            return res;
        } catch (Exception e) {
            logger.error("RedisUtils hget(String key,String item) failure."+e.getMessage());
            if(res == null){
                res = "";
            }
            return res;
    ...
    public static boolean hset(String key,String hashKey,Object value) {
        try {
            ...
            logger.error("RedisUtils hset(String key,String hashKey,Object value) failure."+e.getMessage());
            return false;
        }
    }
    ...
    public static double hincr(String key, String item,double by){
        return redisUtils.redisTemplate.opsForHash().increment(key, item, by);
    }
