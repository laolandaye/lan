...
public class JsoupFirstTest {
    ...
    public void testString() throws Exception {
        //使用工具类读取文件，获取字符串
        String content = FileUtils.readFileToString(new File("C:\\Users\\lan\\Desktop\\test.html"), "utf8");
    ...
    public void testFile() throws Exception {
        //解析文件
        Document doc = Jsoup.parse(new File("C:\\Users\\lan\\Desktop\\test.html"), "utf8");
