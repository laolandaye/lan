package com.lan.javase._7io._1file.示列._1复制文件;
...
class Rename {
     ...
     */
    public static void multiRename(String path, _7io._1file.示列._1复制文件.ReplacementChain replacementChain) {
    ...
    public static void main(String[] args) {
        _7io._1file.示列._1复制文件.ReplacementChain replacementChain = new _7io._1file.示列._1复制文件.ReplacementChain();
