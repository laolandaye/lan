...
public class GitPull {
    ...
    public static void getExeGitPull(String con) {
    ...
    public static List<Map<String, Object>> getBjsjfcPom() {
        List<Map<String, Object>> list = new ArrayList();
        // framework
        list.add( new HashMap<String, Object>(){{ put("branch", "3.5.3-dev"); put("dir", mavenRepository + "/product/framework/v3.5.3/framework "); }});
        // portal
        ...
        list.add( new HashMap<String, Object>(){{ put("branch", "1.0.1-dev"); put("dir", mavenRepository +  "/product/openportal/sdtransportal/openportal "); }});
        // 北京蜂巢
        list.add( new HashMap<String, Object>(){{ put("branch", "master"); put("dir", mavenRepository + "/javaee/fengchao/kun-bjsjfc "); }});
        return list;
    }

    public static List<Map<String, Object>> getSparkPom() {
        List<Map<String, Object>> list = new ArrayList();
        // framework
        list.add( new HashMap<String, Object>(){{ put("branch", "3.5.3-dev"); put("dir", mavenRepository + "/product/framework/v3.5.3/framework "); }});
        // portal
        ...
        list.add( new HashMap<String, Object>(){{ put("branch", "3.5.3-dev"); put("dir", mavenRepository + "/product/jslib/v3.5.3/jslib "); }});
        // 实时 spark
        list.add( new HashMap<String, Object>(){{ put("branch", "feat-add-spark"); put("dir", mavenRepository + "/product/kun-streaming/feat-add-spark/kun-streaming "); }});
        return list;
    }

    public static List<Map<String, Object>> getCqrcbPom() {
        List<Map<String, Object>> list = new ArrayList();
        // framework
        list.add( new HashMap<String, Object>(){{ put("branch", "3.5.3-dev"); put("dir", mavenRepository + "/product/framework/v3.5.3/framework "); }});
        // portal
        ...
        list.add( new HashMap<String, Object>(){{ put("branch", "v3.5.3"); put("dir", mavenRepository + "/product/dp-dataSwitching/v3.5.3/dp-dataSwitching "); }});
        // openportal
        list.add( new HashMap<String, Object>(){{ put("branch", "cqrcb-dev"); put("dir", mavenRepository +  "/product/openportal/cqrcb-dev/openportal "); }});
        return list;
    }
