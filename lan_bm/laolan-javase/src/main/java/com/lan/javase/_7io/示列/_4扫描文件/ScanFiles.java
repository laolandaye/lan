...
/**
 *  扫描文件夹下
 *  https://blog.csdn.net/lq15310444798/article/details/78596482
 */
public class ScanFiles {

    public static void main(String[] args)  throws Exception {
        String folderPath = "D:\\学习视频\\aaa\\八斗大数据培训第九期";

        ArrayList<Object> b1 = scanFilesWithRecursion(folderPath);
        for (Object arg : b1) {
    ...
    public static ArrayList<Object> scanFilesWithRecursion(String folderPath) throws Exception{
        ...
        if(directory.isDirectory()){
            ...
            for(int i = 0; i < filelist.length; i ++){
                ...
                ig.add("target");
                ig.add("node_modules");
                if(filelist[i].isDirectory() && !ig.contains(filelist[i].getName())){
