        ...
        TimerTask timerTast=new TimerTask() {
            ...
            public void run() {
                try{
                    ...
                    System.out.println(CalendarUtil.getInstance().getCurrentDate2_1() + "定时执行一次，包括执行时间");
                }catch(Exception e){
                    System.out.println(CalendarUtil.getInstance().getCurrentDate2_1()+":capacity statistics fail");
                }
            }
        };
        ...
        TimerTask timerTast2=new TimerTask() {
            ...
            public void run() {
                try{
                    ...
                    System.out.println(CalendarUtil.getInstance().getCurrentDate2_1() + "定时执行一次222222，包括执行时间");
                }catch(Exception e){
                    System.out.println(CalendarUtil.getInstance().getCurrentDate2_1()+":capacity statistics fail");
                }
            }
        ...
        TimerTask timerTast=new TimerTask() {
            ...
            public void run() {
                try{
                    ...
                    System.out.println(CalendarUtil.getInstance().getCurrentDate2_1() + "定时执行一次，不包括执行时间");
                }catch(Exception e){
                    System.out.println(CalendarUtil.getInstance().getCurrentDate2_1()+":capacity statistics fail");
                }
            }
