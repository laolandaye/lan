...
class WindowRunnableSynchronizedCode implements Runnable {
	int ticket = 100;// 共享数据
...
public class TestWindowRunnableSynchronizedCode {
	public static void main(String[] args) {
		WindowRunnableSynchronizedCode w = new WindowRunnableSynchronizedCode();
