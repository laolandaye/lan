...
class WindowRunnableSynchronizedMethod implements Runnable {
	int ticket = 100;// 共享数据
...
public class TestWindowRunnableSynchronizedMethod {
	public static void main(String[] args) {
		WindowRunnableSynchronizedMethod w = new WindowRunnableSynchronizedMethod();
