...
public class _2createListMapUtil {
    ...
    public static List<Map<String, Object>> createListMapOther(String dateType, int index, String [] keySets, boolean flag){
        return createListMapOther(new Date(), dateType, index, keySets, flag);
    }
     ...
     * @return
     */
    public static List<Map<String, Object>> createListMapOther(Date date,
            String dateType, int index, String [] keySets, boolean flag){
    ...
    public static List<Map<String, Object>> getListMapOfMonth(
        ...
        List<String> months = ListUtil.createMonthBetween(begin, end, "3");
