...
public class _1mergeListMapOfMappingUtilsTest {
    ...
    public void mergeOfO2mMapping() {
        ...
        _1mergeListMapOfMappingUtils.mergeOfO2mMapping(listMapOut, listMapIn5, keys);
        ...
        _1mergeListMapOfMappingUtils.mergeOfM2oO2oMapping(listMapOut, listMapIn6, keys2);
    ...
    public void mergeOfM2oO2oMapping() {
        ...
        _1mergeListMapOfMappingUtils.mergeOfM2oO2oMapping(listMapOut, listMapIn6, keys);
    ...
    public void mergeOfO2mMappingUpper() {
        ...
        _1mergeListMapOfMappingUtils.mergeOfO2mMappingUpper(listMapOut, listMapIn5, keys);
        ...
        _1mergeListMapOfMappingUtils.mergeOfM2oO2oMappingUpper(listMapOut, listMapIn6, keys2);
    ...
    public void mergeOfM2oO2oMappingUpper() {
        ...
        _1mergeListMapOfMappingUtils.mergeOfM2oO2oMappingUpper(listMapOut, listMapIn6, keys);
